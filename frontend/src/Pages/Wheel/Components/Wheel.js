...
export default class Wheel extends React.Component {
  ...
  render() {
    ...
    cssProperties["padding-top"]=`10px`;
    cssProperties["padding-bottom"]=`60px`;
    ...
    if (cssProperties["--neutral-color"] === "null")
      ...
      return(
        ...
        <h1 className="text-center p-5 underline font-bold text-xl tracking-widest" style={{'textAlign':'center','color':'black'}}>Click to spin</h1>
